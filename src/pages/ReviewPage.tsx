import VoteAccordsList from '@/components/common/fragrance/VoteAccordsList'
...
import useFragranceNotesLayer from '@/hooks/useFragranceNotesLayer'
import { type Fragrance, NoteLayer } from '@/generated/graphql'
import VoteNotesList from '@/components/common/fragrance/VoteNotesList'
...
export type ReviewPageFragrance = Pick<Fragrance, 'id' | 'brand' | 'name' | 'rating'>

export interface ReviewPageProps {
  fragrance: ReviewPageFragrance
  rating: number
}
...
const ReviewPage = (props: ReviewPageProps) => {
  ...
  const { data: images } = useFragranceImages(fragranceId, 1)
