...
import { DropZone, type DropZoneFileRejection } from '@/features/assets'
import { MAX_POST_ASSET_SIZE, MAX_POST_ASSETS, ValidPostAssetType } from '../utils/validation'
import clsx from 'clsx'
import { MdOutlineCloudUpload } from 'react-icons/md'
import { truncate } from 'lodash'
import EditPostMediaUploads from './EditPostMediaUploads'

const EditPostMedia = () => {
  const { uploadTasks, uploadErrors, onUploadAsset } = useEditPostContext()
